...
set_error_handler(function($code, $message, $file, $line) use($log, $config) {
	...
	if ($config->get('error_display')) {
		// code added on 29-11-2023
			$errorMsg = '<b>' . $error . '</b>: ' . $message . ' in <b>' . $file . '</b> on line <b>' . $line . '</b>';
			// Log the error message or store it for later use
			error_log($errorMsg); // Log the error message
		// code added on 29-11-2023
