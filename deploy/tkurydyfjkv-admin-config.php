...
// HTTP
define('HTTP_SERVER', 'https://tkurydyfjkv.diversiply.co/admin/');
define('HTTP_CATALOG', 'https://tkurydyfjkv.diversiply.co/');

// HTTPS
define('HTTPS_SERVER', 'https://tkurydyfjkv.diversiply.co/admin/');
define('HTTPS_CATALOG', 'https://tkurydyfjkv.diversiply.co/');
