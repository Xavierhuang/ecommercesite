<?php
class ControllerExtensionPurpletreeMultivendorAdmintemplate extends Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->request->post['stock_status_id'] = 0;
				$this->request->post['price'] = 0;
				$status1 = '';
				$status1 = $this->request->post['status'];
				$this->request->post['status'] = 0;
			$product_id = $this->model_catalog_product->addProduct($this->request->post);
			$this->request->post['status'] = $status1;
			$this->model_extension_purpletree_multivendor_vendor->addAdmintemp($product_id,$this->request->post);
			...
			$this->request->post['quantity'] = 0;
			$this->request->post['subtract'] = 0;
			$this->request->post['stock_status_id'] = 6;
			$this->request->post['price'] = 0;
			
			$temp_status = $this->model_extension_purpletree_multivendor_vendor->checkTempstatus($this->request->get['product_id']);
			$status1 = '';			
			if($temp_status == 1){
			    $status1 = $this->request->post['status'];
				}else{
			...
			$this->model_extension_purpletree_multivendor_vendor->deleteAdmintempProduct($product_id);
			...
			'href' => $this->url->link('extension/purpletree_multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . $url, true)
			);
			
			$data['add'] = $this->url->link('extension/purpletree_multivendor/admintemplate/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
			$data['delete'] = $this->url->link('extension/purpletree_multivendor/admintemplate/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
			...
			$product_total = $this->model_extension_purpletree_multivendor_vendor->getTotalAdmintempProduct($filter_data);
			
			$results = $this->model_extension_purpletree_multivendor_vendor->geAdmintempProduct($filter_data);
			...
			'model'      => $result['model'],
			'special'    => $special,
			'status'     => $result['pvt_status'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled'),
			'edit'       => $this->url->link('extension/purpletree_multivendor/admintemplate/edit', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $result['product_id'] . $url, true),
			'editdetail'       => $this->url->link('extension/purpletree_multivendor/admintemplate/editTemplateDetail', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $result['product_id'] . '&template_id=' . $result['template_id'] . $url, true)
			...
			$data['sort_name'] = $this->url->link('extension/purpletree_multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, true);
			$data['sort_model'] = $this->url->link('extension/purpletree_multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=p.model' . $url, true);
			$data['sort_status'] = $this->url->link('extension/purpletree_multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, true);
			$data['sort_order'] = $this->url->link('extension/purpletree_multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, true);
			...
			$pagination->url = $this->url->link('extension/purpletree_multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/admintemplate_list', $data));
			}
			...
			$data['action'] = $this->url->link('extension/purpletree_multivendor/admintemplate/edit', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $this->request->get['product_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('extension/purpletree_multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . $url, true);
			...
			$product_info = $this->model_extension_purpletree_multivendor_vendor->getTemplateDetail($this->request->get['template_id']);
			$product_seller = $this->model_extension_purpletree_multivendor_vendor->getProductSeller($this->request->get['template_id']);
			...
			$data['action'] = $this->url->link('extension/purpletree_multivendor/admintemplate/editTemplateDetail', 'user_token=' . $this->session->data['user_token'] . '&template_id=' . $this->request->get['template_id'] . $url, true);
			}
			$data['stock_statuses'] = $this->model_localisation_stock_status->getStockStatuses();
			
			if(isset($this->request->get['template_id'])){	
			$data['template_id'] = $this->model_extension_purpletree_multivendor_vendor->getTemplateId($this->request->get['template_id']);
			} 
				$data['product_id']='';
			if(isset($this->request->get['product_id'])){
			...
			$data['column_left'] = $this->load->controller('common/column_left');
			$data['footer'] = $this->load->controller('common/footer');
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/admintemplatedetail_form',$data));
			}
			public function editTemplateDetail() {
			$this->load->language('purpletree_multivendor/admintemplate');
			...
			$this->model_extension_purpletree_multivendor_vendor->editDetail($this->request->get['template_id'], $this->request->post);
			
			$minprice = $this->model_extension_purpletree_multivendor_vendor->getMinPrice( $this->request->post['product_id']);
			$tproduct_id= $this->model_extension_purpletree_multivendor_vendor->getProductid($this->request->get['template_id']);
			...
			if($this->request->post['status'] == 1){
			    $this->db->query("UPDATE " . DB_PREFIX . "product SET status = '" . (int)$this->request->post['status'] . "' WHERE product_id = '" . (int)$tproduct_id . "'");
				  ...
				  $temp_status = $this->model_extension_purpletree_multivendor_vendor->checkTempstatus($tproduct_id);		
			     if($temp_status == 1){
			      $status1 = 1;
			...
			$this->db->query("UPDATE " . DB_PREFIX . "product SET stock_status_id = '" . (int)$minprice['stock_status_id'] . "', subtract = '" . (int)$minprice['subtract'] . "', quantity = '" . (int)$minprice['quantity'] . "' WHERE product_id = '" . (int)$minprice['product_id'] . "'");
			...
			$template_num_rows = $this->model_extension_purpletree_multivendor_vendor->getTemplateData($this->request->get['template_id'], $this->request->post['seller_id_filter']);
