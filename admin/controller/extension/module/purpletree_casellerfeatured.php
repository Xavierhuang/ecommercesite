<?php
class ControllerExtensionModulePurpletreeCasellerfeatured extends Controller {
		private $error = array();
		
		public function index() {
			$this->load->language('extension/module/purpletree_casellerfeatured');
			...
			if (!isset($this->request->get['module_id'])) {
				...
				'href' => $this->url->link('extension/module/purpletree_casellerfeatured', 'user_token=' . $this->session->data['user_token'], true)
				);
				} else {
				$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/purpletree_casellerfeatured', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true)
				);
			}
			
			$data['action'] = $this->url->link('extension/module/purpletree_casellerfeatured', 'user_token=' . $this->session->data['user_token'], true);
		...
		if (isset($this->request->post['module_purpletree_casellerfeatured_height'])) {
			...
			$this->response->setOutput($this->load->view('extension/module/purpletree_casellerfeatured', $data));
		}
		protected function validate() {
			if (!$this->user->hasPermission('modify', 'extension/module/purpletree_casellerfeatured')) {
