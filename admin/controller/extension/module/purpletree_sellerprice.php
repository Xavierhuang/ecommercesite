...
class ControllerExtensionModulePurpletreeSellerprice extends Controller {
		...
		public function index() {
			...
			'href' => $this->url->link('extension/module/purpletree_sellerprice', 'user_token=' . $this->session->data['user_token'], true)
			);
			
			$data['action'] = $this->url->link('extension/module/purpletree_sellerprice', 'user_token=' . $this->session->data['user_token'], true);
