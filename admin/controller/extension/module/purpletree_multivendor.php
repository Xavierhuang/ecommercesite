...
class ControllerExtensionModulePurpletreeMultivendor extends Controller {
		...
		/// hyper local pop up heading 
			...
			if (isset($this->request->post['module_purpletree_multivendor_hide_products_without_location'])) {
				$data['module_purpletree_multivendor_hide_products_without_location'] = $this->request->post['module_purpletree_multivendor_hide_products_without_location'];
			} else {
				$data['module_purpletree_multivendor_hide_products_without_location'] = $this->config->get('module_purpletree_multivendor_hide_products_without_location');
			}			
