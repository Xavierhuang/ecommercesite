...
class ModelExtensionPaymentSquareup extends Model {
    ...
    public function updateTransaction($squareup_transaction_id, $type, $refunds = array()) {
        ...
        $sql = "UPDATE `" . DB_PREFIX . "squareup_transaction` SET transaction_type='" . $this->db->escape($type) . "', is_refunded='" . (int)!empty($refunds) . "', refunds='" . $this->db->escape(json_encode($refunds)) . "' WHERE squareup_transaction_id='" . (int)$squareup_transaction_id . "'";
    }
