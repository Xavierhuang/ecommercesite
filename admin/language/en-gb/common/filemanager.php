...
$_['error_filesize']   = 'Warning: File is too large. Maximum size is 10MB.';
$_['error_filetype']   = 'Warning: Only JPG, JPEG, GIF and PNG images are allowed.';
$_['error_upload']     = 'Warning: File could not be uploaded for an unknown reason!';
$_['error_upload_move'] = 'Warning: File could not be saved. Check that the folder exists and is writable (e.g. image/catalog).';
