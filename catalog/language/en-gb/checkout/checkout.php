...
$_['text_payment_method']            = 'Please select the preferred payment method to use on this order. TO PAY WITH CREDIT CARD USE PAYPAL PAYOUTS OPTION';
...
// Error
$_['error_minimum_order']            = 'Minimum order amount is %s. Please add more items to your cart.';
