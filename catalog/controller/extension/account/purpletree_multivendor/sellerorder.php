...
class ControllerExtensionAccountPurpletreeMultivendorSellerorder extends Controller{
		...
		public function index(){
			...
			$data['order_statuses'] = $this->model_extension_localisation_ptsorder_status->getOrderStatuses();
			...
			$this->response->setOutput($this->load->view('account/purpletree_multivendor/seller_order_list', $data));
				...
				$canvas_images_d = $this->model_extension_purpletree_multivendor_sellerorder->getCanvasFromOrder($this->request->get['order_id'],$this->request->get['product_id']);
...
//purpletree_product_designer_status
				...
				$pdfUrl='';
				$this->load->model('extension/purpletree_multivendor/sellerorder');
				$canvas_images = $this->model_extension_purpletree_multivendor_sellerorder->getCanvasFromOrder($this->request->get['order_id'],$this->request->get['product_id']);
				$productDesignStatus = $this->model_extension_purpletree_multivendor_sellerorder->getProductDesignStatus($this->request->get['product_id']);
...
readfile($image_url); 
		...
		public function seller_order_info(){
			...
			if(!$this->customer->validateSeller()) {
				$this->load->language('purpletree_multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');
				$this->response->redirect($this->url->link('extension/account/purpletree_multivendor/sellerorder', '', true));
			}
			...
			/// End Help code///
				...
				$this->model_extension_purpletree_multivendor_sellerorder->updateSeenOrders($this->request->get['order_id'],$this->customer->getId());
				...
				$product['canvas_image_c'] = array();
				$pdfUrl='';
				$canvas_images = $this->model_extension_purpletree_multivendor_sellerorder->getCanvasFromOrder($this->request->get['order_id'],$product['product_id']);
				$productDesignStatus = $this->model_extension_purpletree_multivendor_sellerorder->getProductDesignStatus($product['product_id']);
				//if($productDesignStatus) {
				if($this->config->get('module_purpletree_product_designer_status')) {
				if(!empty($canvas_images)) {
				if ($this->request->server['HTTPS']) {
					...
					foreach($canvas_images as $key => $orderitems) {
						...
						'canvas_jpg_image_wtwm_full' => $this->url->link('extension/account/purpletree_multivendor/sellerorder/downloadjpeg', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $product['product_id']. '&key=' . $key. '&order_id=' . $this->request->get['order_id'], true)
						);
					}
				}
					$pdfUrl=$this->url->link('extension/account/purpletree_multivendor/sellerorder/download_pdi', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $product['product_id']. '&order_id=' . $this->request->get['order_id'], true);
					$pdfWithoutWMUrl=$this->url->link('extension/account/purpletree_multivendor/sellerorder/download_without_wm_pdf', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $product['product_id']. '&order_id=' . $this->request->get['order_id'], true);
			}
			//purpletree_product_designer_status
					$data['products'][] = array(
				...
				/* $orderslisttt = $this->model_extension_purpletree_multivendor_sellerorder->getsellerorderunique($this->request->get['order_id'],$this->customer->getId());
				if($orderslisttt) { */
			...
			foreach($data['order_statuses1'] as $key => $value){
				...
				foreach ($custom_fields as $custom_field) {
					if ($custom_field['location'] == 'account' && isset($order_info['custom_field'][$custom_field['custom_field_id']])) {
						if ($custom_field['type'] == 'select' || $custom_field['type'] == 'radio') {
							...
							if (!empty($custom_field_value_info)) {
								$data['account_custom_fields'][] = array(
						...
						if ($custom_field['type'] == 'checkbox' && is_array($order_info['custom_field'][$custom_field['custom_field_id']])) {
							foreach ($order_info['custom_field'][$custom_field['custom_field_id']] as $custom_field_value_id) {
								$custom_field_value_info = $this->model_extension_purpletree_multivendor_custom_field->getCustomFieldValue($custom_field_value_id);
				...
				foreach ($custom_fields as $custom_field) {
					if ($custom_field['location'] == 'address' && isset($order_info['payment_custom_field'][$custom_field['custom_field_id']])) {
						if ($custom_field['type'] == 'select' || $custom_field['type'] == 'radio') {
							$custom_field_value_info = $this->model_extension_purpletree_multivendor_custom_field->getCustomFieldValue($order_info['payment_custom_field'][$custom_field['custom_field_id']]);
				...
				foreach ($custom_fields as $custom_field) {
					if ($custom_field['location'] == 'address' && isset($order_info['shipping_custom_field'][$custom_field['custom_field_id']])) {
						if ($custom_field['type'] == 'select' || $custom_field['type'] == 'radio') {
							$custom_field_value_info = $this->model_extension_purpletree_multivendor_custom_field->getCustomFieldValue($order_info['shipping_custom_field'][$custom_field['custom_field_id']]);
		...
		public function invoice() {
			...
			foreach ($orders as $order_id) {
				...
				if ($order_info) {
					...
					if($this->config->get('module_purpletree_multivendor_seller_invoice')){
						$this->load->model('extension/purpletree_multivendor/vendor');
						$seller_store = $this->model_extension_purpletree_multivendor_vendor->getStoreDetail($seller_id);
						$cus_seller_email  = $this->model_extension_purpletree_multivendor_vendor->getCustomerEmailId($seller_id);
					...
					$orderslisttt = $this->model_extension_purpletree_multivendor_sellerorder->getsellerorderunique($order_id,$this->customer->getId());
					if($orderslisttt) {
						$totals = $this->model_extension_purpletree_multivendor_sellerorder->getOrderTotals($order_id,$this->customer->getId());
						} else {
						$this->load->model('account/order');
			...
			$this->document->addStylepts('catalog/view/javascript/purpletree/bootstrap1/css/bootstrap.css');
			$this->document->addScriptpts('catalog/view/javascript/purpletree/jquery/jquery-2.1.1.min.js');
			$this->document->addScriptpts('catalog/view/javascript/purpletree/bootstrap1/js/bootstrap.min.js');
			$this->document->addStylepts('catalog/view/javascript/purpletree/font-awesome/css/font-awesome.min.css');
			$this->document->addStylepts('catalog/view/javascript/purpletree/css/stylesheet/stylesheet.css');
			$data['stylespts']=$this->document->getStylespts();
			$data['scriptspts']=$this->document->getScriptspts();
