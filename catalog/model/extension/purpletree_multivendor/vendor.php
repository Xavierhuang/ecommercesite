...
class ModelExtensionPurpletreeMultivendorVendor extends Model{
    ...
    public function getRecurringProfileDetail($profile_id) {
            
            $sql="SELECT * FROM ". DB_PREFIX ."recurring r LEFT JOIN ". DB_PREFIX ."recurring_description rd ON (r.recurring_id=rd.recurring_id) WHERE r.recurring_id = ".$profile_id;
            $query = $this->db->query($sql);
